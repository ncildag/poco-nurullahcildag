...
//expects an array of promises as input and return an arrays of values
...
function signIn(event) {
    ...
    if (isUserValid(user, pass)) {
        //login is correct,so remove the from the DOM
        form.remove();
        ...
        document.body.insertAdjacentElement("afterend",ulTag);
    } else {
